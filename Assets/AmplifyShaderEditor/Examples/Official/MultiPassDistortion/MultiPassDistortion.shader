	...
	SubShader
	{
		...
		Pass
		{
			...
			fixed4 frag (v2f i ) : SV_Target
			{
				...
				float4 lerpResult179 = lerp( ( float4( (screenColor151).rgb , 0.0 ) * _Color ) , ( IntersectionColor184 * fresnelNode175 ) , fresnelNode175);
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float screenDepth146 = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE( _CameraDepthTexture, ase_screenPosNorm.xy ));
				float distanceDepth146 = abs( ( screenDepth146 - LinearEyeDepth( ase_screenPosNorm.z ) ) / ( _DepthFadeDistance ) );
...
/*ASEBEGIN
Version=17000
378;241;1020;770;-1965.989;1020.906;1;True;False
...
Node;AmplifyShaderEditor.ColorNode;171;2448,-784;Float;False;Property;_Color;Color;4;0;Create;True;0;0;False;0;0,0,0,0;0.764151,0.2133572,0.1766198,1;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8C98582214E49A31435D73B58875326E3274968F