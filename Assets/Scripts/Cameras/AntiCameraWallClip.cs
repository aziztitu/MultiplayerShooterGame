...
public class AntiCameraWallClip : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        StatefulCinemachineCamera camera = GetComponentInChildren<StatefulCinemachineCamera>(true);
        m_Cam = camera.VirtualCamera.transform;
